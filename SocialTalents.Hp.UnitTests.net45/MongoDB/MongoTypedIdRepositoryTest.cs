...
{
    [TestClass]
    public class MongoTypedIdRepositoryTest
    {
        public MongoTypedIdRepositoryTest()
        {
            BuildRepository();
        }
        ...
        protected virtual void BuildRepository()
        {
            ...
            _repositoryWithOptimisticLock = new MongoTypedIdRepository<MyTestDocument>(_testDb.MongoDatabase, null, null, true);
            _repositoryNoLock = new MongoTypedIdRepository<MyTestDocument>(_testDb.MongoDatabase, null, null, false);
        }
